...
class VotingControllerTest extends AbstractControllerTest {
    ...
    void get() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + "/" + MIRAZUR_RESTAURANT_ID + "/votes/" + VOTE_ID))
    ...
    void createWithLocation() throws Exception {
        ...
        ResultActions action = perform(MockMvcRequestBuilders.post(REST_URL + "/" + MIRAZUR_RESTAURANT_ID + "/votes" ));
    ...
    void update() throws Exception {
        ...
        perform(MockMvcRequestBuilders.put(REST_URL + "/" + NOMA_RESTAURANT_ID + "/votes/"  + VOTE_ID))
    ...
    void getNotFound() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + "/" + MIRAZUR_RESTAURANT_ID + "/votes/" + VOTE_NOT_FOUND))
                .andDo(print())
