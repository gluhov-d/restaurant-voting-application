...
class VotingControllerTest extends AbstractControllerTest {
    ...
    @Test
    @WithUserDetails(value = USER_MAIL)
    @EnabledIf(value = "com.github.restaurantvoting.util.VotingUtil#isVotingOpen()", disabledReason = "Voting is closed")
    ...
    @Test
    @WithUserDetails(value = USER_MAIL)
    @DisabledIf(value = "com.github.restaurantvoting.util.VotingUtil#isVotingOpen()", disabledReason = "Voting is open")
